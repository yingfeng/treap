...
namespace cds_static{
	...
	// const DTsucc RMQ_succinct::HighestBitsSet2[8] = {(DTsucc)~0u, (DTsucc)~1u, (DTsucc)~3u, (DTsucc)~7u, 
	// 		(DTsucc)~15u, (DTsucc)~31u, (DTsucc)~63u, (DTsucc)~127u};
	// // const DTsucc RMQ_succinct_lcp::HighestBitsSet[8] = {~0, ~1, ~3, ~7, ~15, ~31, ~63, ~127};

	DTsucc RMQ_succinct_lcp::clearbits(DTsucc n, uint x) {
			return n & RMQ_succinct::HighestBitsSet[x];
	}
