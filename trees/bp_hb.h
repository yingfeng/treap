...
class bp_hb: public balanced_parentheses{
	private:
		...
		Hashtable *sftable;      // table of far forward pointers
		Hashtable *sbtable;      // table of far backward pointers
		Hashtable *bftable;      // table of near forward pointers
		Hashtable *bbtable;      // table of near backward pointers
		Hashtable *open_sbtable; // table of far backward pointers (for findopen)
		Hashtable *open_bbtable; // table of near backward pointers (for findopen)
